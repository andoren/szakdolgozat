...
\begin{longtable}{|c|c|c|L|}
	...
	ID & Név & V. & Kifejtés \\ 
	\hline 
	1 & Bejelentkezés és jelszó védelem & 0.1 &  \multicolumn{1}{m{7.5cm}|}{
		Legyen egy szép és egyszerű bejelentkezési felület, ahol a felhasználó nevet el lehessen menteni, de csak akkor, ha szeretné a user. A felhasználók jelszavát a rendszergazda se tudja visszanézni, viszont módosítani csak ő tudja. A jelszavak legyenek titkosítva az adatbázisban.
	}\\ 
	\hline 
	...
	\hline 
	9 &  Felhasználó kezelés & 1 & \multicolumn{1}{m{7.5cm}|}{A szerver oldalon is legyen lehetőség a felhasználó felvitelére, módosítására és törlésére. A jelszavak módosítása csak innen legyen lehetséges.} \\ 
	\hline 
