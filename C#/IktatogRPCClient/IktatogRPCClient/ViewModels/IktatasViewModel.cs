...
namespace IktatogRPCClient.ViewModels
{
    class IktatasViewModel:Screen
    {
		public IktatasViewModel()
		{
            ...
            ikonyv1.Partner.Ugyintezok.Add(new PartnerUgyintezo() { Id = 1, Name = "FluffyBoy" });
            ikonyv2.Partner.Ugyintezok.Add(new PartnerUgyintezo() { Id = 1, Name = "FluffyBoy" });
            RecentlyAddedIkonyvek = new BindableCollection<Ikonyv>() {ikonyv1
                ,               ikonyv2
            }; 
        }
